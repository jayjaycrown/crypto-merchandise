...
RegisterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RegisterComponent, selectors: [["app-register"]], decls: 41, vars: 2, consts: [[1, "wrapper"], [1, "container"], [1, "row"], [1, "col-md-10", "offset-md-1"], [1, "card"], [1, "col-md-6", "left"], [1, "col-md-6", "right"], [1, "header"], ["role", "group", "aria-label", "Basic example", 1, "btn-group"], ["type", "button", 1, "btn", "btn-primary", 3, "routerLink"], ["type", "button", 1, "btn", "btn-light", "disabled"], [1, "form-div"], ["action", ""], [1, "input-group", "mb-3"], [1, "input-group-prepend"], [1, "input-group-text"], [1, "fa", "fa-envelope"], ["type", "email", "id", "inlineFormInputGroup", "placeholder", "Enter your Email", 1, "form-control"], ["aria-hidden", "true", 1, "fa", "fa-user-secret"], ["type", "text", "id", "inlineFormInputGroup", "placeholder", "Enter your full name", 1, "form-control"], ["aria-hidden", "true", 1, "fa", "fa-unlock"], ["type", "password", "id", "inlineFormInputGroup", "placeholder", "Enter your Password", 1, "form-control"], ["type", "password", "id", "inlineFormInputGroup", "placeholder", "Enter your password", 1, "form-control"], [1, "btn", "btn-primary", "btn-lg", "btn-block", "btn-round"]], template: function RegisterComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "div", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "div", 3);
